            ...
            case false:
                return (
                    <div className='user-authentication__content'>
                        <button className='ui google plus button user-authentication__button'>
                            <a
                                href='/auth/google'
                        ...
                        <button className='ui facebook button user-authentication__button'>
                            <a
                                href='/auth/facebook'
                                className='user-authentication__link'
                            >
                        ...
                        <button className='ui linkedin button user-authentication__button'>
                            <a
                                href='/auth/linkedin'
                                className='user-authentication__link'
                            >
